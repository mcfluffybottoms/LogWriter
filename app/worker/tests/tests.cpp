...
int main() {
  ...
  runner.runTest("Simple log message", [&runner, &expected]() {
  ...
  // TEST 2
  expected = {"[DEBUG][...] LOGGER MESSAGE 1", "[DEBUG][...] LOGGER MESSAGE 2",
              "[DEBUG][...] LOGGER MESSAGE 3", "[DEBUG][...] LOGGER MESSAGE 4",
              "[DEBUG][...] LOGGER MESSAGE 5", ""};
  runner.runTest(
      "Simple log message with multiple threads", [&runner, &expected]() {
        ...
        std::array<longStream, 5> streams = {longStream(1), longStream(2),
                                             longStream(3), longStream(4),
                                             longStream(5)};
  ...
  // TEST 3
  expected = {"[CRITICAL][...] LOGGER MESSAGE 3",
              "[CRITICAL][...] LOGGER MESSAGE 6", ""};
  runner.runTest(
      "Simple log message with multiple threads and different log levels",
      [&runner, &expected]() {
        ...
        std::array<longStream, 6> streams = {longStream(1), longStream(2),
                                             longStream(3), longStream(4),
                                             longStream(5), longStream(6)};
  ...
  // TEST 4
  expected = {
      "[DEBUG][...] LOGGER MESSAGE 1",    "[INFO][...] LOGGER MESSAGE 2",
      "[CRITICAL][...] LOGGER MESSAGE 3", "[DEBUG][...] LOGGER MESSAGE 4",
      "[INFO][...] LOGGER MESSAGE 5",     "[CRITICAL][...] LOGGER MESSAGE 6",
  };
  runner.runTest(
      "Ending logging should be thread-safe",
      [&runner, &expected]() {
